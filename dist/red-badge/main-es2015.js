...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<img id=\"picture\" src=\"../../assets/imgs/loginBackground.jpg\" style=\"max-width: 100%; min-width: 100%\">\r\n<div id=\"register\">\r\n<h2>Register</h2>\r\n<form [formGroup]=\"registerForm\" (ngSubmit)=\"onSubmit()\">\r\n    <div class=\"form-group\">\r\n        <label for=\"userName\">Username</label>\r\n        <input type=\"text\" formControlName=\"userName\" class=\"form-control\" [ngClass]=\"{ 'is-invalid': submitted && f.userName.errors }\" />\r\n        <div *ngIf=\"submitted && f.userName.errors\" class=\"invalid-feedback\">\r\n            <div *ngIf=\"f.userName.errors.required\">Username is required</div>\r\n        </div>\r\n    </div>\r\n    <div class=\"form-group\">\r\n        <label for=\"password\">Password</label>\r\n        <input type=\"password\" formControlName=\"password\" class=\"form-control\" [ngClass]=\"{ 'is-invalid': submitted && f.password.errors }\" />\r\n        <div *ngIf=\"submitted && f.password.errors\" class=\"invalid-feedback\">\r\n            <div *ngIf=\"f.password.errors.required\">Password is required</div>\r\n            <div *ngIf=\"f.password.errors.minlength\">Password must be at least 6 characters</div>\r\n        </div>\r\n    </div>\r\n    <div class=\"form-group\">\r\n        <button [disabled]=\"loading\" class=\"btn btn-primary\">\r\n            <span *ngIf=\"loading\" class=\"spinner-border spinner-border-sm mr-1\"></span>\r\n            Register\r\n        </button>\r\n        <a routerLink=\"/login\" class=\"btn btn-link\">Cancel</a>\r\n    </div>\r\n</form>\r\n</div>\r\n");
...
let EditGamesComponent = class EditGamesComponent {
    constructor(activatedRoute, router, formBuilder, databaseService, data) {
...
EditGamesComponent.ctorParameters = () => [
...
let FavoritesComponent = class FavoritesComponent {
    constructor(DatabaseService, http, dialog) {
        this.DatabaseService = DatabaseService;
        this.http = http;
        this.dialog = dialog;
        this.toggle = false;
    ...
    openFavUpdate(game) {
        const dialogRef = this.dialog.open(_edit_games_edit_games_component__WEBPACK_IMPORTED_MODULE_4__["EditGamesComponent"], {
            data: game
        });
...
let GamesComponent = class GamesComponent {
    ...
    openAddGames(game) {
        const dialogRef = this.dialog.open(_add_game_add_game_component__WEBPACK_IMPORTED_MODULE_5__["AddGameComponent"], {
            data: game
        });
        dialogRef.afterClosed().subscribe(res => {
            this.getAllGames();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("#login{\r\n    margin: 0;\r\n    position: absolute;\r\n    top: 50%;\r\n    left: 50%;\r\n    margin-right: -50%;\r\n    transform: translate(-50%, -50%);\r\n    color: white;\r\n  }\r\n  .form-control{\r\n    width: 100%;\r\n    text-align: left;\r\n    border: 1px solid;\r\n  }\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
let LoginComponent = class LoginComponent {
    constructor(formBuilder, route, router, authenticationService, alertService, databaseService) {
        this.formBuilder = formBuilder;
        this.route = route;
        this.router = router;
        this.authenticationService = authenticationService;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\r\n#register{\r\n    margin: 0;\r\n    position: absolute;\r\n    top: 50%;\r\n    left: 50%;\r\n    margin-right: -50%;\r\n    transform: translate(-50%, -50%);\r\n    color: white;\r\n}\r\n.form-control{\r\n    width: 100%;\r\n    text-align: left;\r\n    border: 1px solid;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
let AuthenticationService = class AuthenticationService {
    ...
    login(userName, password) {
        return this.http.post(`${_environments_environment_prod__WEBPACK_IMPORTED_MODULE_5__["APIURL"]}/auth/signin`, { userName, password })
